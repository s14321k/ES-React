...
export default function UseStateCount() {
    ...
    //     setCount(count - 1);
    // }
    const increment = () => {setCount(count + counts)}
    const decrement = () => {setCount(count - counts)}
    ...
    const incrementBy = () => {setCounts(counts + 1)}
    const decrementBy = () => {setCounts(counts - 1)}

    
    return (
        <> 
            <h1>Event Handler onClick in react(jsx attribute) where is onclick in js</h1>
            ...
            <button onClick={() => setCount(previousCount => previousCount + 1)}>Increment Type 2</button>
            <button onClick={() => setCount(previousCount => previousCount - 1)}>Decrement Type 2</button>
            <br/>
