...
export default function UseStateObject() {
    ...
    function handleInput(e) {
        ...
        console.log("input wont reflect in view ... uncomment the bellow line ::::   "+ e.target.value);
    ...
    return (
        <>
            ...
            <form>
                <h3>States does not automatically merge the changes. We need to do it manually.<br/> Check the bellow</h3>
                <input 
                    type = "text"
                ...
                <h3>This add button will not refresh the page on submit by using preventDefault() method</h3>
