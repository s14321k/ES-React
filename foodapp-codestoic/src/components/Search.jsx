...
export default function Search({foodData, setFoodData}) {
    ...
    useEffect(() => {
        async function fetchFood() {
            ...
            const data = await response.json();   /* This function will be called asynchronasly before the fetch happens. So we will face the error stating that "response.json is not a function". For that we should use "async" before the function and "await" before the fetch as used above. "await" is better way than the "promise" and ".then" */
